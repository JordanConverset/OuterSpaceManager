...
public class SearchActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvSearches = (RecyclerView) findViewById(R.id.searches);
        ...
        Call<Searches> request = service.getSearches(settings.getString("users", new String()));
        request.enqueue(new Callback<Searches>() {
            @Override
            public void onResponse(Call<Searches> call, Response<Searches> response) {
                rvSearches.setAdapter(new SearchArrayAdapter(getApplicationContext(), response.body().getSearches()));
            }
